                    ...
                    <div class="purchase-card-body">
                        <form action="#" id="step1Form" method="post" enctype="multipart/form-data" style="margin: 0px 12%;">
                            ...
                            <div class="mb-4" style="display:flex !important; flex-direction:row !important; justify-content: space-between !important; align-items:baseline">
                                <input class="form-control num" type="text" maxlength="1" style="width:30px; text-align:center;" name="code[]" id="num1" placeholder="X" required>
                                <input class="form-control num" type="text" maxlength="1" style="width:30px; text-align:center;" name="code[]" id="num2" placeholder="X" required>
                                <input class="form-control num" type="text" maxlength="1" style="width:30px; text-align:center;" name="code[]" id="num3" placeholder="X" required>
                                <input class="form-control num" type="text" maxlength="1" style="width:30px; text-align:center;" name="code[]" id="num4" placeholder="X" required>
                            </div>
